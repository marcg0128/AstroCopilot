...
export default function NavBar() {
    return (
        <nav className="m-0 flex px-30 justify-between h-[10vh] w-full items-center relative bg-transparent">
            <div className="flex-1">
                <h1 className="text-3xl font-bold text-(--text-primary)">
                    AstroCopilot
                </h1>
            </div>
            <GlassBoxComponent style=" flex h-16 justify-center px-10  ">
            ...
            <div className="flex-1 flex justify-end ">
                <GlassBoxComponent style="flex justify-center items-center h-16">
